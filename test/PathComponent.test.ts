...
describe("Path component should ", () => {
    ...
    it("hold the type of path it represent", () => {
        ...
        let myLinePath = new PathComponent(ID.next(), true, pathType.polyline, 1, 2, defaultStyle);
    ...
    it("hold the id of the first point that compose the path from the points pool", () => {
        let myPath = new PathComponent(ID.next(), true, pathType.polyline, 1, 2, defaultStyle);
    ...
    it("hold the number of points that compose the path", () => {
        ...
        const nbPt = 6;
        let myPath = new PathComponent(ID.next(), true, pathType.polyline, 1, nbPt, defaultStyle);
    ...
    it("hold stroke style information", () => {
        ...
        let myPath = new PathComponent(ID.next(), true, pathType.polyline, 1, 2, style);
