...
import { CompoundPathComponent, IPathStyle, IRange } from "../src/CompoundPathComponent";
...
export {  IRange, CompoundPathComponent, IPathStyle, cubicBezierUtil, CompoundPathEntityFactory, CompoundPathRendererSystem, ICompoundPathRendererParams, DebugCompoundPathRendererSystem, computeLength, getPointAt, PathComponent, pathType, PathEntityFactory, PointComponent, svgPathUtil, MouseComponent, TracePathSystem  };
